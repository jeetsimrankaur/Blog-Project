...
<form name=frm3 method=post action='viewtopic.jsp?t=2&p=<%=request.getParameter("p")%>'>
    Dislike<input type=radio name=s value="dislike" onclick="abc()">
...
<%
    ...
    {
        if(request.getParameter("r").equals("like"))
            {
